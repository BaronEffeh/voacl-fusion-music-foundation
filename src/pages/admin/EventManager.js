...
//   const [saving, setSaving] = useState(false); // Modal form loading
//   const [editingEvent, setEditingEvent] = useState(null);
//   const [formData, setFormData] = useState({
//     title: "",
//     type: "",
...
// import React, { useState, useEffect } from "react";
// import axios from "axios";
// import { Box, Modal, Typography, TextField, Button, Grid, CircularProgress } from "@mui/material";
// import EventStatsSection from "../../components/admin/eventManager/EventStatsSection";
// import EventListSection from "../../components/admin/eventManager/EventListSection";
...
//   // Base URL (adjust if your API docs specify otherwise)
//   // const API_BASE_URL = "https://api.vocalfusionfoundation.org/api";
//   const API_BASE_URL = "https://vocal-fusion.onrender.com";
...
//     type: formData.type,
//     location: formData.location,
//     date: eventDateTime, // send combined ISO datetime
//   };
...
// //     } catch (error) {
// //   console.error("Error adding event:", error.response?.data || error.message);
// //   alert(error.response?.data?.message || "Failed to add event. Please check your input.");
// // }
