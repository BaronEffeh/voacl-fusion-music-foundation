  ...
  return (
    <Box sx={{ py: 8, px: { xs: 2, md: 6 }, textAlign: 'center' }}>
      <Typography variant="h5" gutterBottom>
        Choral Challenge 2025
      </Typography>
      <Typography variant="body1" maxWidth="1152px" mx="auto" mb={5}>
        The Choral Challenge took place in March 2025, attracting a total of six talented schools from 
        across the region. The event brought together young, vibrant voices in a spirited display of 
        harmony, creativity, and musical excellence. After a series of powerful performances and intense 
        competition, St Patrick’s Secondary School, Ikpayngo, Benue State emerged as the overall 
...
export default CoralChallenge2025;
